...
class AdvisorAssessmentController extends Controller
{
    ...
    private function validateClientProfile(array $profile): array
    {
        Validator::make($profile, [
            ...
            'portfolio_preferences' => ['required', 'array:scope,primary_currency,country,markets,tax_sensitive,exclusions'],
            ...
            'portfolio_preferences.exclusions' => ['present', 'array', 'max:20'],
            'portfolio_preferences.exclusions.*' => ['string', 'max:80'],
