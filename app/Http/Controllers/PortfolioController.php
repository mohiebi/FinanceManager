...
class PortfolioController extends Controller
{
    public function __invoke(Request $request, AssetPriceService $priceService): Response
    {
        ...
        /** @var \Illuminate\Support\Collection<int, Investment> $allEntries */
        ...
        foreach ($grouped as $typeValue => $typeEntries) {
            ...
            // Weighted-average cost basis across entries that have it
        ...
        // Per-entry breakdown with cost-basis details
