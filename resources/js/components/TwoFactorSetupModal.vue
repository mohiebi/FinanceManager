...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    ...
    if (showVerificationStep.value) {
        return {
            title: t('settings.security.two_factor_verify_title'),
            description: t('settings.security.two_factor_verify_description'),
            buttonText: t('buttons.continue'),
        };
    }

    return {
        title: t('settings.security.two_factor_setup_title'),
        description: t('settings.security.two_factor_setup_description'),
        buttonText: t('buttons.continue'),
    };
});
