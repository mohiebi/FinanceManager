...
usePageSubtitle(() =>
    t('gamification.page.subtitle', {
        rank: t(`gamification.ranks.${props.logbook.rank}`),
...
defineOptions({
    layout: {
        breadcrumbs: [{ title: 'FlightLog', href: flightLog().url }],
    },
});
</script>
...
<template>
    ...
    >
        <div class="grid gap-[18px] xl:grid-cols-2">
            <!-- ── Current run ─────────────────────────────────────── -->
            <section
                class="rounded-[16px] border border-white/7 bg-[#1a1a1a] px-6 py-[22px]"
            >
                ...
                <div class="mt-5 flex items-end gap-3">
                    ...
                    <span class="mb-1.5">
                        ...
                        <span class="mt-0.5 block text-xs text-[#686868]">{{
                ...
                <ul class="mt-3 flex flex-wrap gap-x-4 gap-y-1.5">
                    <li
                        ...
                        :key="state"
                        class="flex items-center gap-1.5 text-[11px] text-[#686868]"
                    >
                        <span
            ...
            >
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-[#686868]">
                            {{
                ...
                <div class="mt-5 flex flex-wrap items-center gap-7">
                    <div class="relative size-[116px] shrink-0">
                        ...
                        >
                            ...
                            >
                            <span
                                class="mt-0.5 text-[9.5px] tracking-[0.16em] text-[#686868] uppercase"
                                >{{
            ...
            >
                ...
                <p class="mt-1.5 text-[12.5px] leading-6 text-[#686868]">
                    ...
                    >
                        <span class="flex min-w-0 items-start gap-3">
                            ...
                            <span class="min-w-0">
                                ...
                                >
                                <span
                                    class="mt-0.5 block text-xs text-[#686868]"
                                    >{{
                                        rank.threshold === 0
                                            ? t(
            ...
            >
                ...
                <ol class="mt-4">
                    ...
                    >
                        ...
                        <span
                            class="shrink-0 text-xs text-[#686868]"
                            dir="ltr"
                            >{{
                                moment.achieved_at
