<template>
    ...
    <div
        class="flex h-full flex-1 flex-col gap-6 overflow-x-auto bg-[#2d2d2d] p-4 sm:p-6"
    >
        <section
            class="rounded-none bg-[#454545] px-5 py-4 text-white shadow-sm sm:rounded-t-sm sm:px-7"
        >
            <div
                class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between"
            >
                <div class="flex items-center gap-4">
                    <AppLogoIcon class="size-8 text-[#02cd86]" />
                ...
                <div
                    class="flex flex-col gap-4 sm:flex-row sm:items-center lg:min-w-lg lg:justify-end"
                >
                    <div class="flex items-center gap-4">
                        <Label
                            for="display_currency"
                            class="text-lg font-normal text-white"
                        >
                            Currency
                        </Label>
        ...
        <section class="rounded-[22px] bg-white p-5 shadow-sm">
            <div
        ...
        <div class="grid gap-5 lg:grid-cols-2">
            <section class="overflow-hidden rounded-[22px] bg-white shadow-sm">
                <div class="flex items-center justify-between gap-4 px-5 py-7">
                    <div>
                    ...
                    <Button
                        class="h-14 rounded-md bg-[#947bff] px-4 text-xl font-bold text-white hover:bg-[#856def]"
                        @click="openCreateForm('cost')"
                    >
                        Add Cost
                        <span
                            class="grid size-9 place-items-center rounded-md bg-[#2d2d2d]/75"
                        >
                            <Plus class="size-6" />
                        </span>
                    </Button>
                ...
                <div class="overflow-x-auto px-3 pb-5">
                    <table class="w-full text-sm">
                        <thead>
                            <tr
                                class="rounded-2xl bg-[#f0ecff] text-left text-base text-black"
                            >
                                <th
                                    class="rounded-l-2xl px-3 py-4 text-center font-normal sm:px-5"
                                >
                                    Subject
                                </th>
                                <th
                                    class="px-3 py-4 text-center font-normal sm:px-5"
                                >
                                    Category
                                </th>
                                <th
                                ...
                                <th
                                    class="hidden rounded-r-2xl px-3 py-4 text-center font-normal sm:table-cell sm:px-5"
                                >
                                    Date
                                </th>
                        ...
                        <tbody>
                            <tr
                                ...
                                :key="transaction.id"
                                class="group hover:bg-[#f7f7f7]"
                            >
                                <td
                                    class="px-3 py-4 text-center text-base text-black sm:px-5"
                                >
                                    <button
                                        class="text-black"
                                        type="button"
                                ...
                                <td class="px-3 py-4 text-center sm:px-5">
                                    <span
                                        class="inline-flex min-w-28 justify-center rounded-md bg-[#d9d9d9] px-4 py-2 text-base text-black"
                                    >
                                        {{
                                ...
                                <td
                                    class="hidden px-3 py-4 text-center text-base text-black sm:table-cell sm:px-5"
                                >
                                    {{ transaction.occurred_at }}
                                </td>
                                <td class="px-3 py-4 sm:px-5">
                                    <div
                                        class="flex justify-end gap-1 opacity-100 sm:gap-2 lg:opacity-0 lg:transition-opacity lg:group-hover:opacity-100"
                                    >
                                        <Button
                                            variant="ghost"
                                            size="sm"
            ...
            <section class="overflow-hidden rounded-[22px] bg-white shadow-sm">
                <div class="flex items-center justify-between gap-4 px-5 py-7">
                    ...
                    <Button
                        class="h-14 rounded-md bg-[#02cd86] px-4 text-xl font-bold text-white hover:bg-[#02b978]"
