...
return [
    ...
    'security' => [
        ...
        'sessions' => [
            ...
            'revoke' => 'Revoke',
            'revoke_confirm_title' => 'Revoke this session?',
            'revoke_confirm_body' => 'That device will be signed out immediately and will need to sign in again.',
            'empty' => 'No sign-in sessions found.',
    ...
    'assets' => [
        ...
        'asset_class_none' => 'Not set',
        'underlying' => 'Tracks',
        'underlying_none' => 'Nothing — it is its own market',
        'underlying_help' => 'If this asset is a form of one you already track — a half gold coin, a silver bar — point it at that one. The portfolio and the AI advisor will then count them as a single exposure instead of separate holdings.',
        'underlying_ratio' => 'Worth per unit ({unit})',
        'underlying_ratio_placeholder' => 'e.g. 4.6',
        'underlying_self' => 'An asset cannot track itself.',
        'underlying_not_root' => 'That asset already tracks another one. Point at what it tracks instead.',
        'underlying_has_variants' => 'Other assets track this one, so it cannot track something itself.',
        'tracks' => 'Tracks {asset}',
