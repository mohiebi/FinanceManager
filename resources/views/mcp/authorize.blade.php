        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <div class="flex flex-col space-y-1.5 p-6">
                <div class="flex items-center justify-center mb-4">
                    <img src="{{ Vite::asset('resources/img/Logo-green.svg') }}" alt="{{ config('app.name', 'CashPilot') }}" class="h-12 w-12" />
                </div>
            ...
            <div class="p-6 pt-0 space-y-4">
                ...
                <div class="rounded-lg border p-4 bg-muted/50">
                    <p class="text-sm text-muted-foreground mb-2">{{ __('settings.ai.authorize.logged_in_as') }}</p>
                ...
                @if(count($scopes) > 0)
                    <div class="space-y-2">
                        <p class="text-sm font-medium">{{ __('settings.ai.authorize.permissions') }}</p>
